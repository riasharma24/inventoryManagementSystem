...
public class CategoryManagerCategoryCodeExistsTestCase
{
...
if(categoryManager.categoryCodeExists(Integer.parseInt(gg[0])))System.out.println("Category : "+gg[0]+" exists.");
else System.out.println("Category : "+gg[0]+" does not exist.");
