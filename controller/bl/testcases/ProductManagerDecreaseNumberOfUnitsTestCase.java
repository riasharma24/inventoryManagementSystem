...
public class ProductManagerDecreaseNumberOfUnitsTestCase
{
...
productManager.decreaseNumberOfUnits(Integer.parseInt(gg[0]));
System.out.println("Number of units for product with id : "+gg[0]+" decreased.");
