...
public class CategoryDAOCodeExistsTestCase
{
public static void main(String gg[])
{
CategoryDAOInterface categoryDAO;
categoryDAO=new CategoryDAO();
if(categoryDAO.codeExists(Integer.parseInt(gg[0])))System.out.println("Code : "+gg[0]+" exists.");
else System.out.println("Code : "+gg[0]+" does not exist.");
}
}