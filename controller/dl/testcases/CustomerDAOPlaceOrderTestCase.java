...
public class CustomerDAOPlaceOrderTestCase
{
...
customerDAO.placeOrder(customerDTO);
System.out.println("Orders placed for customer with id : "+customerDTO.getCustomerId());
